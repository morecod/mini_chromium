...
#ifndef MINI_CHROMIUM_SRC_CRURL_URL_CANON_IP_H_
#define MINI_CHROMIUM_SRC_CRURL_URL_CANON_IP_H_
...
CRURL_EXPORT void AppendIPv4Address(const unsigned char address[4],
                                    CanonOutput* output);

// Writes the given IPv6 address to |output|.
CRURL_EXPORT void AppendIPv6Address(const unsigned char address[16],
                                    CanonOutput* output);
...
#endif  // MINI_CHROMIUM_SRC_CRURL_URL_CANON_IP_H_