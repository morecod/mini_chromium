...
#ifndef MINI_CHROMIUM_CRURL_THIRD_PARTY_MOZILLA_URL_PARSE_H_
#define MINI_CHROMIUM_CRURL_THIRD_PARTY_MOZILLA_URL_PARSE_H_
...
CRURL_EXPORT void ParsePathURL(const char* url,
                               int url_len,
                               bool trim_path_end,
                               Parsed* parsed);
...
CRURL_EXPORT void ParseAuthority(const char* spec,
...
// return false.
CRURL_EXPORT bool ExtractQueryKeyValue(const char* url,
                                       Component* query,
                                       Component* key,
                                       Component* value);
...
#endif  // MINI_CHROMIUM_CRURL_THIRD_PARTY_MOZILLA_URL_PARSE_H_