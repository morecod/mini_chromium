...
#ifndef MINI_CHROMIUM_CRURL_URL_CANON_H_
#define MINI_CHROMIUM_CRURL_URL_CANON_H_
...
class CRURL_EXPORT CharsetConverter {
 public:
  CharsetConverter() {}
...
CRURL_EXPORT bool CanonicalizeScheme(const char* spec,
...
//
// The 8-bit version requires UTF-8 encoding.
CRURL_EXPORT bool CanonicalizeUserInfo(const char* username_source,
...
CRURL_EXPORT bool CanonicalizeHost(const char* spec,
...
CRURL_EXPORT void CanonicalizeHostVerbose(const char* spec,
                                          const Component& host,
                                          CanonOutput* output,
...
CRURL_EXPORT void CanonicalizeIPAddress(const char* spec,
                                        const Component& host,
                                        CanonOutput* output,
                                        CanonHostInfo* host_info);
...
//
// The 8-bit version requires UTF-8 encoding.
CRURL_EXPORT bool CanonicalizePort(const char* spec,
...
CRURL_EXPORT int DefaultPortForScheme(const char* scheme, int scheme_len);
...
CRURL_EXPORT bool CanonicalizePath(const char* spec,
...
//
// The 8-bit version requires UTF-8 encoding.
CRURL_EXPORT bool FileCanonicalizePath(const char* spec,
                                       const Component& path,
                                       CanonOutput* output,
                                       Component* out_path);
...
CRURL_EXPORT void CanonicalizeQuery(const char* spec,
...
CRURL_EXPORT void CanonicalizeRef(const char* spec,
                                  const Component& path,
                                  CanonOutput* output,
                                  Component* out_path);
...
CRURL_EXPORT bool CanonicalizeStandardURL(const char* spec,
                                          int spec_len,
                                          const Parsed& parsed,
...
// Use for file URLs.
CRURL_EXPORT bool CanonicalizeFileURL(const char* spec,
                                      int spec_len,
                                      const Parsed& parsed,
                                      CharsetConverter* query_converter,
                                      CanonOutput* output,
...
CRURL_EXPORT bool CanonicalizeFileSystemURL(const char* spec,
                                            int spec_len,
                                            const Parsed& parsed,
                                            CharsetConverter* query_converter,
                                            CanonOutput* output,
...
CRURL_EXPORT bool CanonicalizePathURL(const char* spec,
                                      int spec_len,
                                      const Parsed& parsed,
                                      CanonOutput* output,
                                      Parsed* new_parsed);
...
CRURL_EXPORT bool CanonicalizeMailtoURL(const char* spec,
                                        int spec_len,
                                        const Parsed& parsed,
                                        CanonOutput* output,
                                        Parsed* new_parsed);
...
CRURL_EXPORT bool ReplaceStandardURL(const char* base,
...
CRURL_EXPORT bool ReplaceFileSystemURL(const char* base,
                                       const Parsed& base_parsed,
                                       const Replacements<char>& replacements,
                                       CharsetConverter* query_converter,
                                       CanonOutput* output,
...
CRURL_EXPORT bool ReplaceFileURL(const char* base,
                                 const Parsed& base_parsed,
                                 const Replacements<char>& replacements,
                                 CharsetConverter* query_converter,
                                 CanonOutput* output,
...
// will be ignored.
CRURL_EXPORT bool ReplacePathURL(const char* base,
                                 const Parsed& base_parsed,
                                 const Replacements<char>& replacements,
                                 CanonOutput* output,
                                 Parsed* new_parsed);
...
// All other components will be ignored.
CRURL_EXPORT bool ReplaceMailtoURL(const char* base,
                                   const Parsed& base_parsed,
                                   const Replacements<char>& replacements,
                                   CanonOutput* output,
                                   Parsed* new_parsed);
...
#endif  // MINI_CHROMIUM_CRURL_URL_CANON_H_