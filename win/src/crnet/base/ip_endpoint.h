...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_IP_ENDPOINT_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_IP_ENDPOINT_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_IP_ENDPOINT_H_