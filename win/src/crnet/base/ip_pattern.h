...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_IP_PATTERN_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_IP_PATTERN_H_
...
class CRNET_EXPORT IPPattern {
 public:
  IPPattern(const IPPattern&) = delete;
  IPPattern& operator=(const IPPattern&) = delete;
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_IP_PATTERN_H_