...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_IP_ADDRESS_NET_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_IP_ADDRESS_NET_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_IP_ADDRESS_NET_H_