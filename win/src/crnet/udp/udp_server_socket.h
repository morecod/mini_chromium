...
#ifndef MINI_CHROMIUM_CRNET_SOCKET_UDP_SERVER_SOCKET_H_
#define MINI_CHROMIUM_CRNET_SOCKET_UDP_SERVER_SOCKET_H_
...
#endif  // MINI_CHROMIUM_CRNET_SOCKET_UDP_SERVER_SOCKET_H_