...
#ifndef MINI_CHROMIUM_SRC_CRNET_SOCKET_TCP_SOCKET_WIN_H_
#define MINI_CHROMIUM_SRC_CRNET_SOCKET_TCP_SOCKET_WIN_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_SOCKET_TCP_SOCKET_WIN_H_