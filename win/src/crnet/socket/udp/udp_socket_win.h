...
#ifndef MINI_CHROMIUM_SRC_CRNET_SOCKET_UDP_UDP_SOCKET_WIN_H_
#define MINI_CHROMIUM_SRC_CRNET_SOCKET_UDP_UDP_SOCKET_WIN_H_
...
class CRNET_EXPORT DscpManager {
 public:
 ...
 private:
  ...
  cr::WeakPtrFactory<DscpManager> weak_ptr_factory_{this};
};
...
class CRNET_EXPORT UDPSocketWin
 ...
 private:
  ...
  cr::WeakPtrFactory<UDPSocketWin> event_pending_{this};
};

}  // namespace crnet

#endif  // MINI_CHROMIUM_SRC_CRNET_SOCKET_UDP_UDP_SOCKET_WIN_H_