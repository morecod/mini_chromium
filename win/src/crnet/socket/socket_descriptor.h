...
#ifndef MINI_CHROMIUM_CRNET_SOCKET_SOCKET_DESCRIPTOR_H_
#define MINI_CHROMIUM_CRNET_SOCKET_SOCKET_DESCRIPTOR_H_
...
#endif  // MINI_CHROMIUM_CRNET_SOCKET_SOCKET_DESCRIPTOR_H_