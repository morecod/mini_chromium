...
#ifndef MINI_CHROMIUM_SRC_CRBASE_TRACING_TRACKED_OBJECTS_H_
#define MINI_CHROMIUM_SRC_CRBASE_TRACING_TRACKED_OBJECTS_H_
...
class CRBASE_EXPORT BirthOnThread {
 public:
  BirthOnThread(const BirthOnThread&) = delete;
  BirthOnThread& operator=(const BirthOnThread&) = delete;
...
class CRBASE_EXPORT Births: public BirthOnThread {
 public:
  Births(const Births&) = delete;
  Births& operator=(const Births&) = delete;
...
class CRBASE_EXPORT DeathData {
 public:
  DeathData& operator=(const DeathData&) = delete;
