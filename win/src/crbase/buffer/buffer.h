...
#ifndef MINI_CHROMIUM_SRC_CRBASE_BUFFER_BUFFER_H_
#define MINI_CHROMIUM_SRC_CRBASE_BUFFER_BUFFER_H_
...
#include "crbase/memory/zero_memory.h"
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_BUFFER_BUFFER_H_
