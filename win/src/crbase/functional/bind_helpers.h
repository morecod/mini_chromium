...
//
// Passed() is for transferring movable-but-not-copyable types (eg. std::unique_ptr)
...
#ifndef MINI_CHROMIUM_SRC_CRBASE_FUNCTIONAL_BIND_HELPERS_H_
#define MINI_CHROMIUM_SRC_CRBASE_FUNCTIONAL_BIND_HELPERS_H_
...
#pragma warning(pop)
  ...
  template <typename C>
  static No& Check(Helper<&C::AddRef>*) {No r; return r;};

  template <typename >
  static Yes& Check(...) {Yes r; return r;};
...
class HasIsMethodTag {
  ...
  template <typename U>
  static Yes& Check(typename U::IsMethod*) {Yes r; return r;};

  template <typename U>
  static No& Check(...) {No r; return r;};
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_FUNCTIONAL_BIND_HELPERS_H_
