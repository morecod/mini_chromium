...
#ifndef MINI_CHROMIUM_SRC_CRBASE_FUNCTIONAL_CALLBACK_H_
#define MINI_CHROMIUM_SRC_CRBASE_FUNCTIONAL_CALLBACK_H_
...
//   CR_LOG(INFO) << func_cb.Run();  // Prints 5.
//
...
//    public:
//     int Foo() { return 3; }
//     void PrintBye() { CR_LOG(INFO) << "bye."; }
//   };
//   crbase::scoped_refptr<Ref> ref = new Ref();
//   crbase::Callback<void()> ref_cb = crbase::Bind(&Ref::Foo, ref);
//   CR_LOG(INFO) << ref_cb.Run();  // Prints out 3.
//
...
//
//   void DoSomething(
//       const crbase::Callback<void(int, std::string)>& callback) {
...
//   crbase::Callback<void(int, const std::string&)> cb = 
//       crbase::Bind(&MyFunc);
...
//   pointer.
//
//   crbase::Closure cb = crbase::Bind(&MyClass::MyFunc, this, 23, 
//                                       "hello world");
//
...
//
//   void MyFunc(int i, const std::string& str) {}
//   crbase::Callback<void(const std::string&)> cb 
//       = crbase::Bind(&MyFunc, 23);
//   cb.Run("hello world");
//
...
//   int* pn = new int(1);
//   crbase::Closure foo_callback = crbase::Bind(&foo, base::Owned(pn));
//
//   The parameter will be deleted when the callback is destroyed, even if it's
//   not run (like if you post a task during shutdown).
//
// PASSING PARAMETERS AS A std::unique_ptr
//
...
//
// PASSING PARAMETERS AS A crbase::scoped_refptr
//
//   void TakesOneRef(crbase::scoped_refptr<Foo> arg) {}
//   crbase::scoped_refptr<Foo> f(new Foo);
//   crbase::Closure cb = base::Bind(&TakesOneRef, f);
//
...
// please include "crbase/functional/callback_forward.h" instead.
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_FUNCTIONAL_CALLBACK_H_