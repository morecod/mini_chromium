...
#define MSVC_NON_EXPORTED_BASE(code) MSVC_SUPPRESS_WARNING(4275) \
                                     code
#else  // Not MINI_CHROMIUM_COMPILER_MSVC
...
#define MSVC_NON_EXPORTED_BASE(code) code
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_COMPILER_SPECIFIC_H_
