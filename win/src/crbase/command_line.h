...
class CRBASE_EXPORT CommandLine {
 public:
  ...
  typedef std::map<StringPiece, const StringType*> StringPieceSwitchMap;
  ...
  void AppendArg(const std::string& value1, const std::string& value2);
  void AppendArgNative(const StringType& value1, const StringType& value2);
