...
#ifndef MINI_CHROMIUM_CRBASE_TIMER_TIMER_H_
#define MINI_CHROMIUM_CRBASE_TIMER_TIMER_H_
...
class CRBASE_EXPORT TimerBase {
 public:
  ...
  // If |tick_clock| is provided, it is used instead of TimeTicks::Now() to get
  // TimeTicks when scheduling tasks.
  TimerBase(const tracked_objects::Location& posted_from, TimeDelta delay);
  TimerBase(const tracked_objects::Location& posted_from,
            TimeDelta delay,
 ...
 protected:
  ...
  void StartInternal(const tracked_objects::Location& posted_from, 
                     TimeDelta delay);
...
class CRBASE_EXPORT RepeatingTimer : public internal::TimerBase {
 public:
  ...
  RepeatingTimer(const tracked_objects::Location& posted_from,
                 TimeDelta delay,
...
class CRBASE_EXPORT RetainingOneShotTimer : public internal::TimerBase {
 public:
  ...
  RetainingOneShotTimer(const tracked_objects::Location& posted_from,
                        TimeDelta delay,
                        RepeatingClosure user_task);
  RetainingOneShotTimer(const tracked_objects::Location& posted_from,
                        TimeDelta delay,
