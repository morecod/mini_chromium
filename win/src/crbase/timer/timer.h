...
#ifndef MINI_CHROMIUM_SRC_CRBASE_TIMER_TIMER_H_
#define MINI_CHROMIUM_SRC_CRBASE_TIMER_TIMER_H_
...
class CRBASE_EXPORT Timer {
 public:
  ...
  Timer(const tracked_objects::Location& posted_from,
        TimeDelta delay,
        const crbase::Closure& user_task,
        bool is_repeating);
  ...
  const crbase::Closure& user_task() const { return user_task_; }
 ...
 public:
  ...
  void Start(const tracked_objects::Location& posted_from,
    ...
    Timer::Start(posted_from, delay,
                 crbase::Bind(method, crbase::Unretained(receiver)));
  }
};
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_TIMER_TIMER_H_