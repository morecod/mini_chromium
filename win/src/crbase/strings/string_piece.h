...
#ifndef MINI_CHROMIUM_SRC_CRBASE_STRINGS_STRING_PIECE_H_
#define MINI_CHROMIUM_SRC_CRBASE_STRINGS_STRING_PIECE_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_STRINGS_STRING_PIECE_H_