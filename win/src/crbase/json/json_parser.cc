...
class DictionaryHiddenRootValue : public DictionaryValue {
 public:
  DictionaryHiddenRootValue(const DictionaryHiddenRootValue&) = delete;
  DictionaryHiddenRootValue& operator=(const DictionaryHiddenRootValue&) = delete;
...
class ListHiddenRootValue : public ListValue {
 public:
  ListHiddenRootValue(const ListHiddenRootValue&) = delete;
  ListHiddenRootValue& operator=(const ListHiddenRootValue&) = delete;
...
class JSONStringValue : public Value {
 public:
  JSONStringValue(const JSONStringValue&) = delete;
  JSONStringValue& operator=(const JSONStringValue&) = delete;
