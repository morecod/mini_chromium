...
#ifndef MINI_CHROMIUM_SRC_CRBASE_WIN_SHORTCUT_H_
#define MINI_CHROMIUM_SRC_CRBASE_WIN_SHORTCUT_H_
...
struct CRBASE_EXPORT ShortcutProperties {
  ...
  void set_arguments(const string16& arguments_in) {
    ...
    CR_DCHECK_LT(static_cast<int>(arguments_in.size()), MAX_PATH);
  ...
  void set_description(const string16& description_in) {
    ...
    CR_DCHECK_LT(static_cast<int>(description_in.size()), MAX_PATH);
