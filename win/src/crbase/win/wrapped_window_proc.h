...
#ifndef MINI_CHROMIUM_SRC_CRBASE_WIN_WRAPPED_WINDOW_PROC_H_
#define MINI_CHROMIUM_SRC_CRBASE_WIN_WRAPPED_WINDOW_PROC_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_WIN_WRAPPED_WINDOW_PROC_H_
