...
LONG RegKey::CreateKey(const wchar_t* name, REGSAM access) {
  ...
  HKEY subkey = NULL;
  LONG result = ::RegCreateKeyExW(key_, name, 0, NULL, REG_OPTION_NON_VOLATILE,
...
bool RegKey::HasValue(const wchar_t* name) const {
  return ::RegQueryValueExW(key_, name, 0, NULL, NULL, NULL) == ERROR_SUCCESS;
}

DWORD RegKey::GetValueCount() const {
  DWORD count = 0;
  LONG result = ::RegQueryInfoKeyW(key_, NULL, 0, NULL, NULL, NULL, NULL, &count,
                                   NULL, NULL, NULL, NULL);
...
LONG RegKey::GetValueNameAt(int index, std::wstring* name) const {
  ...
  LONG r = ::RegEnumValueW(key_, index, buf, &bufsize, NULL, NULL, NULL, NULL);
  if (r == ERROR_SUCCESS)
    *name = buf;
...
LONG RegKey::DeleteEmptyKey(const wchar_t* name) {
  ...
  LONG result = ::RegOpenKeyExW(key_, name, 0, KEY_READ | wow64access_,
                                &target_key);
  ...
  DWORD count = 0;
  result = ::RegQueryInfoKeyW(target_key, NULL, 0, NULL, NULL, NULL, NULL,
...
void RegistryValueIterator::Initialize(HKEY root_key,
  ...
  if (result != ERROR_SUCCESS) {
    ...
    DWORD count = 0;
    result = ::RegQueryInfoKeyW(key_, NULL, 0, NULL, NULL, NULL, NULL, &count,
                                NULL, NULL, NULL, NULL);
...
DWORD RegistryValueIterator::ValueCount() const {
  DWORD count = 0;
  LONG result = ::RegQueryInfoKeyW(key_, NULL, 0, NULL, NULL, NULL, NULL,
                                   &count, NULL, NULL, NULL, NULL);
  if (result != ERROR_SUCCESS)
    return 0;
...
DWORD RegistryKeyIterator::SubkeyCount() const {
  DWORD count = 0;
  LONG result = ::RegQueryInfoKeyW(key_, NULL, 0, NULL, &count, NULL, NULL,
...
bool RegistryKeyIterator::Read() {
  if (Valid()) {
    ...
    FILETIME written;
    LONG r = ::RegEnumKeyExW(key_, index_, name_, &ncount, NULL, NULL,
                             NULL, &written);
    if (ERROR_SUCCESS == r)
      return true;
  }
...
void RegistryKeyIterator::Initialize(HKEY root_key,
  ...
  if (result != ERROR_SUCCESS) {
    ...
    DWORD count = 0;
    result = ::RegQueryInfoKeyW(key_, NULL, 0, NULL, &count, NULL, NULL, NULL,
                                NULL, NULL, NULL, NULL);
