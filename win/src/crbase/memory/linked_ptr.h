...
#ifndef MINI_CHROMIUM_SRC_CRBASE_MEMORY_LINKED_PTR_H_
#define MINI_CHROMIUM_SRC_CRBASE_MEMORY_LINKED_PTR_H_
...
// TODO(http://crbug.com/556939): DEPRECATED: Use std::unique_ptr instead (now
// that we have support for moveable types inside STL containers).
template <typename T>
class linked_ptr {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_MEMORY_LINKED_PTR_H_