...
#ifndef MINI_CHROMIUM_SRC_CRBASE_MEMORY_ZERO_MEMORY_H_
#define MINI_CHROMIUM_SRC_CRBASE_MEMORY_ZERO_MEMORY_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_MEMORY_ZERO_MEMORY_H_
