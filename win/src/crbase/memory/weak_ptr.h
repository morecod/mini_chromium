...
#ifndef MINI_CHROMIUM_SRC_CRBASE_MEMORY_WEAK_PTR_H_
#define MINI_CHROMIUM_SRC_CRBASE_MEMORY_WEAK_PTR_H_
...
class WeakPtr : public internal::WeakPtrBase {
 ...
 private:
  ...
  template <class U> bool operator==(WeakPtr<U> const&) const = delete;
  template <class U> bool operator!=(WeakPtr<U> const&) const = delete;
